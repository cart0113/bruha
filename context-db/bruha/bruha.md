...
file (`bruha.json`), providing a custom CSS theme with four color palettes,
sidebar enhancements, collapsible folders, and a horizontal top nav bar. Start
with `overview.md` for what it does and key design decisions. `architecture.md`
traces the config flow from JSON through Python to the JS runtime.
