...
to localStorage keys namespaced by site path (e.g. `/bruha:doc-theme`,
`/bruha:doc-dark-mode`, `/bruha:doc-code-highlighter`) so multiple Bruha
sites on the same origin don't share settings.
