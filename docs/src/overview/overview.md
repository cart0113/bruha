...
- **Rich content widgets**: 8 callout types (`note`, `tip`, `important`,
  ...
  key styling, and collapsible sections.
...
- **Context-db files provided** — this project uses
  ...
  `context-db/using-bruha/` context files which can be copied, symlinked, or
  somehow integrated into your project. In addition, a `templates/` directory
